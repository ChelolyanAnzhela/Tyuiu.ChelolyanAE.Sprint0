using Tyuiu.ChelolyanAE.Sprint0.Task7.V0.Lib;

namespace Tyuiu.ChelolyanAE.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 |Выполнила: Челольян А. Е. | ИИПБ-24-2";
            Console.WriteLine("***************************************************************************");
            ...
            Console.WriteLine("Значение эелементов массива №1");
